...
if true; then
  ...
  cp out/windows/godot.windows.opt.32.exe ${templatesdir}/windows_64_release.exe
  cp out/windows/godot.windows.opt.debug.32.exe ${templatesdir}/windows_64_debug.exe
